...
def generate_att_map(image_, heatmap, image_name, img_save_dir):
...
if __name__ == '__main__':
    ...
    model_checkpoint_path = "logs_cone_vis_work/checkpoint0010.pth"
    img_dir = "/data1/gcx002/Datasets/gooreal/head_free_transgop/val"
    img_save_dir = "vis_Wo_CONE/"
    ann = "/data1/gcx002/Datasets/gooreal/head_free_transgop/annotations/val.json"

    # synth
    # model_config_path = "config/DINO/DINO_4scale.py"
    # model_checkpoint_path = "logs_synth/checkpoint0024.pth"
    # img_dir = "/data1/gcx003/Datasets/goosynth/head_free_transgop/val"
    # img_save_dir = "vis_GOP_synth/"
    # ann = "/data1/gcx003/Datasets/goosynth/head_free_transgop/annotations/val.json"
    ...
    for i in os.listdir(img_dir):
        ...
        if os.path.exists(os.path.join(img_save_dir, i)):
            ...
            generate_att_map(image, gaze_output.squeeze(1)[-1], image_name, img_save_dir)
            print(n)
    print('done !')