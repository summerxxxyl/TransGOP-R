...
# class Head_Backbone(BackboneBase):
#     """ResNet backbone with frozen BatchNorm."""
#     def __init__(self, name: str,
#                  train_backbone: bool,
#                  dilation: bool,
...
#                  ):
#         if name in ['resnet18', 'resnet34', 'resnet50', 'resnet101']:
#             head_backbone = getattr(torchvision.models, name)(
#                 replace_stride_with_dilation=[False, False, dilation],
#                 pretrained=is_main_process(), norm_layer=batch_norm)

# backbone & position embedding
...
def build_backbone(args):
    ...
    # if args.head_backbone in ['resnet50', 'resnet101']:
    #     head_backbone = Head_Backbone(args.backbone, train_backbone, args.dilation,
    #                             return_interm_indices,
    #                             batch_norm=nn.BatchNorm2d)

    # if args.head_backbone in ['resnet50', 'resnet101']:
    #     head_backbone = Head_Backbone(args.head_backbone, train_backbone, args.dilation,
    #                             return_interm_indices,
